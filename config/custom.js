  ...
  enums: {
    ...
    analytics: {
      ...
      event: {
        ...
        ACCOUNTS_ACTIVE_TEST_TOTAL: 'accounts_active_test_total',
        ACCOUNTS_DELETED_TEST_TOTAL: 'accounts_deleted_test_total',
        ACCOUNTS_BANNED_TEST_TOTAL: 'accounts_banned_test_total',
        ACCOUNTS_ACTIVE_BRONZE_TOTAL: 'accounts_active_bronze_total',
        ACCOUNTS_NOT_ACTIVE_BRONZE_TOTAL: 'accounts_not_active_bronze_total',
        ACCOUNTS_DELETED_BRONZE_TOTAL: 'accounts_deleted_bronze_total',
        ACCOUNTS_BANNED_BRONZE_TOTAL: 'accounts_banned_bronze_total',
        ACCOUNTS_ACTIVE_GOLD_TOTAL: 'accounts_active_gold_total',
        ACCOUNTS_NOT_ACTIVE_GOLD_TOTAL: 'accounts_not_active_gold_total',
        ACCOUNTS_DELETED_GOLD_TOTAL: 'accounts_deleted_gold_total',
        ACCOUNTS_BANNED_GOLD_TOTAL: 'accounts_banned_gold_total',
        ACCOUNTS_ACTIVE_PLATINUM_TOTAL: 'accounts_active_platinum_total',
        ACCOUNTS_NOT_ACTIVE_PLATINUM_TOTAL: 'accounts_not_active_platinum_total',
        ACCOUNTS_DELETED_PLATINUM_TOTAL: 'accounts_deleted_platinum_total',
        ACCOUNTS_BANNED_PLATINUM_TOTAL: 'accounts_banned_platinum_total',
        NEW_ACCOUNTS_ACTIVE_ALL: 'new_accounts_active_all',
        NEW_ACCOUNTS_NOT_ACTIVE_ALL: 'new_accounts_not_active_all',
        NEW_ACCOUNTS_TEST: 'new_accounts_test',
        NEW_ACCOUNTS_ACTIVE_BRONZE: 'new_accounts_active_bronze',
        NEW_ACCOUNTS_NOT_ACTIVE_BRONZE: 'new_accounts_not_active_bronze',
        NEW_ACCOUNTS_ACTIVE_GOLD: 'new_accounts_active_gold',
        NEW_ACCOUNTS_NOT_ACTIVE_GOLD: 'new_accounts_not_active_gold',
        NEW_ACCOUNTS_ACTIVE_PLATINUM: 'new_accounts_active_platinum',
        NEW_ACCOUNTS_NOT_ACTIVE_PLATINUM: 'new_accounts_not_active_platinum',
