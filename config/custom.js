...
module.exports.custom = {
  ...
  ***************************************************************************/
  ...
  enums: {
    ...
    serviceNames: {
      testPersonal: 'test_personal',
      testPersonalInitial: 'test_personal_initial',
      bronzePersonal: 'bronze_personal',
      silverPersonal: 'silver_personal',
      goldPersonal: 'gold_personal',
      platinumPersonal: 'platinum_personal',
      testCommercial: 'test_commercial',
      testCommercialInitial: 'test_commercial_initial',
      bronzeCommercial: 'bronze_commercial',
      silverCommercial: 'silver_commercial',
      goldCommercial: 'gold_commercial',
      platinumCommercial: 'platinum_commercial',
      star054: 'star054',
      star108: 'star108',
      star153: 'star153',
      star306: 'star306',
    ...
    messageFormat: {
      ...
      STICKER: 'sticker',
      DOC: 'doc',
      IMGCALLBACK: 'imgInlineKeyboard',
      DEL: 'del',
      EDIT_RM: 'editReplyMarkup',
      EDIT_T: 'editText',
      POSTBROADCAST: 'postBroadcast',
      PUSHSIMPLE: 'pushSimple',
      PUSHCALLBACK: 'pushInlineKeyboard',
      PUSHIMGCALLBACK: 'pushImgInlineKeyboard',
      PUSHVIDEOCALLBACK: 'pushVideoInlineKeyboard',
