  ...
  enums: {
    ...
    analytics: {
      ...
      event: {
        ...
        NEW_ACCOUNTS_ALL: 'new_accounts_all',
        NEW_ACCOUNTS_TEST: 'new_accounts_test',
        NEW_ACCOUNTS_BRONZE: 'new_accounts_bronze',
        NEW_ACCOUNTS_GOLD: 'new_accounts_gold',
        NEW_ACCOUNTS_PLATINUM: 'new_accounts_platinum',
