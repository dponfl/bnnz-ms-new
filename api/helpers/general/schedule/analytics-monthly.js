...
const moduleName = 'general::schedule::analytics-monthly';


module.exports = {


  friendlyName: 'Scheduler for calculation and saving monthly analytics data',

  description: 'Scheduler for calculation and saving monthly analytics data',
  ...
  fn: async function (inputs, exits) {
    ...
    try {
      ...
      for (const event of sails.config.custom.config.analyticSchedule.monthly) {
