      ...
      switch (input.query.data) {
        case 'check_befree_p':
          ...
          nextBlockActivationGenericParams = {
            ...
            block: input.block,
            updateElement: 'next',
            updateElementValue: 'options::befree_p_start',
        ...
        case 'check_belike':
          ...
          nextBlockActivationGenericParams = {
            ...
            block: input.block,
            updateElement: 'next',
            updateElementValue: 'options::belike_start',
            updateElementPreviousValue: 'options::get_personal',
            createdBy: moduleName,
            msg: input.msg,
          };
        ...
        case 'check_behero':
          ...
          nextBlockActivationGenericParams = {
            ...
            block: input.block,
            updateElement: 'next',
            updateElementValue: 'options::behero_start',
            updateElementPreviousValue: 'options::get_personal',
            createdBy: moduleName,
            msg: input.msg,
          };
        ...
        case 'check_bestar':
          ...
          nextBlockActivationGenericParams = {
            ...
            block: input.block,
            updateElement: 'next',
            updateElementValue: 'options::bestar_start',
            updateElementPreviousValue: 'options::get_personal',
            createdBy: moduleName,
            msg: input.msg,
          };
        ...
        case 'check_belegend':
          ...
          nextBlockActivationGenericParams = {
            ...
            block: input.block,
            updateElement: 'next',
            updateElementValue: 'options::belegend_start',
            updateElementPreviousValue: 'options::get_personal',
            createdBy: moduleName,
            msg: input.msg,
          };
