...
const moduleName = 'funnel:generic:options:callback-be-like-info-joi';


module.exports = {


  friendlyName: 'funnel:generic:options:callback-be-like-info-joi',


  description: 'funnel:generic:options:callback-be-like-info-joi',
