...
const moduleName = 'funnel:generic:options:callback-be-creator-info-joi';


module.exports = {


  friendlyName: 'funnel:generic:options:callback-be-creator-info-joi',


  description: 'funnel:generic:options:callback-be-creator-info-joi',
  ...
  fn: async function (inputs, exits) {
    ...
    try {
      ...
      switch (input.query.data) {
        case 'funnel_becreator':

          switchFunnelToAnyBlockParams = {
            client,
            serviceName: 'silver_commercial',
            funnelName: 'optin',
