...
const moduleName = 'funnel:generic:options:before-be-creator-info-joi';


module.exports = {


  friendlyName: 'funnel:generic:options:before-be-creator-info-joi',


  description: 'funnel:generic:options:before-be-creator-info-joi',
  ...
  fn: async function (inputs, exits) {
    ...
    try {
      ...
      const currentServiceName = 'silver_commercial';
