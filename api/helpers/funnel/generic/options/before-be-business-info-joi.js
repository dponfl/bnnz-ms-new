...
const moduleName = 'funnel:generic:options:before-be-business-info-joi';


module.exports = {


  friendlyName: 'funnel:generic:options:before-be-business-info-joi',


  description: 'funnel:generic:options:before-be-business-info-joi',
  ...
  fn: async function (inputs, exits) {
    ...
    try {
      ...
      const currentServiceName = 'platinum_commercial';
