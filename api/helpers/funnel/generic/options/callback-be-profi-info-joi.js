...
const moduleName = 'funnel:generic:options:callback-be-profi-info-joi';


module.exports = {


  friendlyName: 'funnel:generic:options:callback-be-profi-info-joi',


  description: 'funnel:generic:options:callback-be-profi-info-joi',
