...
const moduleName = 'funnel:generic:options:callback-be-hero-info-joi';


module.exports = {


  friendlyName: 'funnel:generic:options:callback-be-hero-info-joi',


  description: 'funnel:generic:options:callback-be-hero-info-joi',
