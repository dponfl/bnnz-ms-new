...
const moduleName = 'funnel:generic:options:before-be-master-info-joi';


module.exports = {


  friendlyName: 'funnel:generic:options:before-be-master-info-joi',


  description: 'funnel:generic:options:before-be-master-info-joi',
  ...
  fn: async function (inputs, exits) {
    ...
    try {
      ...
      const currentServiceName = 'bronze_commercial';
