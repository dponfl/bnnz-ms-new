...
const moduleName = 'funnel:generic:options:before-be-star-info-joi';


module.exports = {


  friendlyName: 'funnel:generic:options:before-be-star-info-joi',


  description: 'funnel:generic:options:before-be-star-info-joi',
  ...
  fn: async function (inputs, exits) {
    ...
    try {
      ...
      const currentServiceName = 'gold_commercial';
