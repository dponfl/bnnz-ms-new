...
const moduleName = 'funnel:generic:options:callback-be-business-info-joi';


module.exports = {


  friendlyName: 'funnel:generic:options:callback-be-business-info-joi',


  description: 'funnel:generic:options:callback-be-business-info-joi',
  ...
  fn: async function (inputs, exits) {
    ...
    try {
      ...
      switch (input.query.data) {
        case 'funnel_bebusiness':

          switchFunnelToAnyBlockParams = {
            client,
            serviceName: 'platinum_commercial',
            funnelName: 'optin',
            blockId: 'start_sticker',
