...
const moduleName = 'funnel:generic:options:callback-be-star-info-joi';


module.exports = {


  friendlyName: 'funnel:generic:options:callback-be-star-info-joi',


  description: 'funnel:generic:options:callback-be-star-info-joi',
