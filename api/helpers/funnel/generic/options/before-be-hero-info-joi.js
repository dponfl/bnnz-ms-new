...
const moduleName = 'funnel:generic:options:before-be-hero-info-joi';


module.exports = {


  friendlyName: 'funnel:generic:options:before-be-hero-info-joi',


  description: 'funnel:generic:options:before-be-hero-info-joi',
  ...
  fn: async function (inputs, exits) {
    ...
    try {
      ...
      const currentServiceName = 'silver_personal';
