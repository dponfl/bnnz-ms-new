...
const moduleName = 'funnel:generic:options:callback-be-master-info-joi';


module.exports = {


  friendlyName: 'funnel:generic:options:callback-be-master-info-joi',


  description: 'funnel:generic:options:callback-be-master-info-joi',
  ...
  fn: async function (inputs, exits) {
    ...
    try {
      ...
      switch (input.query.data) {
        case 'funnel_bemaster':

          switchFunnelToAnyBlockParams = {
            client,
            serviceName: 'bronze_commercial',
            funnelName: 'optin',
