...
const moduleName = 'funnel:generic:options:callback-be-free-personal-info-joi';


module.exports = {


  friendlyName: 'funnel:generic:options:callback-be-free-personal-info-joi',


  description: 'funnel:generic:options:callback-be-free-personal-info-joi',
