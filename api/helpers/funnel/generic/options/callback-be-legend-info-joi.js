...
const moduleName = 'funnel:generic:options:callback-be-legend-info-joi';


module.exports = {


  friendlyName: 'funnel:generic:options:callback-be-legend-info-joi',


  description: 'funnel:generic:options:callback-be-legend-info-joi',
