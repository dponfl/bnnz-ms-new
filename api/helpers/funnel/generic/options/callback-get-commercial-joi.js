      ...
      switch (input.query.data) {
        case 'check_befree_c':
          ...
          nextBlockActivationGenericParams = {
            ...
            block: input.block,
            updateElement: 'next',
            updateElementValue: 'options::befree_c_info_01',
        ...
        case 'check_bemaster':
          ...
          nextBlockActivationGenericParams = {
            ...
            block: input.block,
            updateElement: 'next',
            updateElementValue: 'options::bemaster_info_01',
            updateElementPreviousValue: 'options::get_commercial',
            createdBy: moduleName,
            msg: input.msg,
          };
        ...
        case 'check_becreator':
          ...
          nextBlockActivationGenericParams = {
            ...
            block: input.block,
            updateElement: 'next',
            updateElementValue: 'options::becreator_info_01',
            updateElementPreviousValue: 'options::get_commercial',
            createdBy: moduleName,
            msg: input.msg,
          };
        ...
        case 'check_beprofi':
          ...
          nextBlockActivationGenericParams = {
            ...
            block: input.block,
            updateElement: 'next',
            updateElementValue: 'options::beprofi_info_01',
            updateElementPreviousValue: 'options::get_commercial',
            createdBy: moduleName,
            msg: input.msg,
          };
        ...
        case 'check_bebusiness':
          ...
          nextBlockActivationGenericParams = {
            ...
            block: input.block,
            updateElement: 'next',
            updateElementValue: 'options::bebusiness_info_01',
            updateElementPreviousValue: 'options::get_commercial',
            createdBy: moduleName,
            msg: input.msg,
          };
