...
module.exports = {
  ...
  friendlyName: 'help::callbackSelectedBronze',


  description: 'help::callbackSelectedBronze',
  ...
  fn: async function (inputs, exits) {
    ...
    try {
      ...
      sails.log.info('/*************** help::callbackSelectedBronze ***************/');
      ...
      switch (inputs.query.data) {
        case 'change_service':
          ...
          if (getBlock) {
            getBlock.previous = 'help::selected_bronze';
          }
      ...
      sails.log.error('api/helpers/funnel/help/callback-selected-bronze, error: ', e);

      throw {err: {
          module: 'api/helpers/funnel/help/callback-selected-bronze',
          message: 'api/helpers/funnel/help/callback-selected-bronze error',
          payload: {},
        }
      };
