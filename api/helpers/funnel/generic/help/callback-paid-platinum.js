...
module.exports = {
  ...
  friendlyName: 'help::callbackPaidPlatinum',


  description: 'help::callbackPaidPlatinum',
  ...
  fn: async function (inputs, exits) {
    ...
    try {
      ...
      sails.log.info('/*************** help::callbackPaidPlatinum ***************/');
      ...
      switch (inputs.query.data) {
        case 'subscription_confirm':
          ...
          if (getBlock) {
            getBlock.previous = 'help::platinum_paid';
          }
      ...
      sails.log.error('api/helpers/funnel/help/callback-paid-platinum, error: ', e);

      throw {err: {
          module: 'api/helpers/funnel/help/callback-paid-platinum',
          message: 'api/helpers/funnel/help/callback-paid-platinum error',
          payload: {},
        }
      };
