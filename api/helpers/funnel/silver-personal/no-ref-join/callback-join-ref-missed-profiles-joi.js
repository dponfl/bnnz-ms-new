...
const moduleName = 'funnel:silver-personal:no-ref-join:callback-join-ref-missed-profiles-joi';


module.exports = {


  friendlyName: 'funnel:silver-personal:no-ref-join:callback-join-ref-missed-profiles-joi',


  description: 'funnel:silver-personal:no-ref-join:callback-join-ref-missed-profiles-joi',
      ...
      switch (input.query.data) {
        case 'check':
          ...
          if (blockData) {
            ...
            blockData.next = null;
            blockData.previous = 'noRefJoin::join_ref_missed_profiles';
