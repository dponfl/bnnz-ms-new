...
const moduleName = 'funnel:chat-blasts:test-personal-push-to-paid:callback-bestar-make-payment-joi-on-payment-error-joi';


module.exports = {


  friendlyName: 'funnel:chat-blasts:test-personal-push-to-paid:callback-bestar-make-payment-joi-on-payment-error-joi',


  description: 'funnel:chat-blasts:test-personal-push-to-paid:callback-bestar-make-payment-joi-on-payment-error-joi',
  ...
  fn: async function (inputs, exits) {
    ...
    try {
      ...
      input.block.next = 'chatBlasts.testPersonal.pushToPaid.funnelOne::bestar_payment_error';
