...
const moduleName = 'funnel:chat-blasts:test-personal-push-to-paid:before-belike-make-payment-joi';


module.exports = {


  friendlyName: 'funnel:chat-blasts:test-personal-push-to-paid:before-belike-make-payment-joi',


  description: 'funnel:chat-blasts:test-personal-push-to-paid:before-belike-make-payment-joi',
    ...
    try {
      ...
      for (const p of pool) {
        ...
        try {
          ...
          // No actions needed here because we already loged error above
