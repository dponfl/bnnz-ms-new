...
const moduleName = 'api:helpers:funnel:chat-blasts:test-personal-push-to-paid:callback-common-make-payment-joi-on-payment-error-joi';


module.exports = {


  friendlyName: 'api:helpers:funnel:chat-blasts:test-personal-push-to-paid:callback-common-make-payment-joi-on-payment-error-joi',


  description: 'api:helpers:funnel:chat-blasts:test-personal-push-to-paid:callback-common-make-payment-joi-on-payment-error-joi',
  ...
  fn: async function (inputs, exits) {
    ...
    try {
      ...
      /**
       * Устанавливаем значение для следующего блока в 'xxx_payment_error'
       */
