...
const moduleName = 'funnel:chat-blasts:test-personal-push-to-paid:callback-belegend-make-payment-again-joi';


module.exports = {


  friendlyName: 'funnel:chat-blasts:test-personal-push-to-paid:callback-belegend-make-payment-again-joi',


  description: 'funnel:chat-blasts:test-personal-push-to-paid:callback-belegend-make-payment-again-joi',
...
// TODO: Временная заглушка по причине нереботы тестовых платежей: Начало
            ...
            if (getBlock) {
              getBlock.previous = 'chatBlasts.testPersonal.pushToPaid.funnelOne::belegend_payment_error';
...
// TODO: Временная заглушка по причине нереботы тестовых платежей: Окончание
        ...
        case 'contact_support':
          ...
          // TODO: Добавить коммуникацию с клиентской поддержкой

          /**
           * В качестве заглушки просто логируем факт нажатия кнопки
           */

          await LogProcessor.info({
            message: '"contact_support" button pressed',
            clientGuid,
            accountGuid,
            errorName: sails.config.custom.GENERAL_LOGGER.name,
            location: moduleName,
            payload: null,
          });
