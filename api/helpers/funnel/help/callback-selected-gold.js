module.exports = {
  ...
  friendlyName: 'help::callbackSelectedGold',


  description: 'help::callbackSelectedGold',
  ...
  fn: async function (inputs, exits) {
    ...
    try {
      ...
      sails.log.info('/*************** help::callbackSelectedGold ***************/');
      ...
      switch (inputs.query.data) {
        case 'change_service':
          ...
          if (getBlock) {
            getBlock.previous = 'help::selected_gold';
          }
      ...
      sails.log.error('api/helpers/funnel/help/callback-selected-gold, error: ', e);

      throw {err: {
          module: 'api/helpers/funnel/help/callback-selected-gold',
          message: 'api/helpers/funnel/help/callback-selected-gold error',
          payload: {},
        }
      };
