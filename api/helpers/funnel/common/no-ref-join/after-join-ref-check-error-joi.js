...
const moduleName = 'funnel:common:no-ref-join:after-join-ref-check-error-joi';


module.exports = {


  friendlyName: 'funnel:common:no-ref-join:after-join-ref-check-error-joi',


  description: 'funnel:common:no-ref-join:after-join-ref-check-error-joi',
