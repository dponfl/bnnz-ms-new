...
const moduleName = 'funnel:common:optin:before-join-ref-missed-profiles-joi';


module.exports = {


  friendlyName: 'funnel:common:optin:before-join-ref-missed-profiles-joi',


  description: 'funnel:common:optin:before-join-ref-missed-profiles-joi',
