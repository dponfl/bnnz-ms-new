...
const moduleName = 'funnel:common:optin:callback-make-payment-again-joi';


module.exports = {


  friendlyName: 'funnel:common:optin:callback-make-payment-again-joi',


  description: 'funnel:common:optin:callback-make-payment-again-joi',
