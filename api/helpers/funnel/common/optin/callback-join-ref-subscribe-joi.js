...
const moduleName = 'funnel:common:optin:callback-join-ref-subscribe-joi';


module.exports = {


  friendlyName: 'funnel:common:optin:callback-join-ref-subscribe-joi',


  description: 'funnel:common:optin:callback-join-ref-subscribe-joi',
