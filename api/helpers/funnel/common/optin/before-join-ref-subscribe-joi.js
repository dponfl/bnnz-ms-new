...
const moduleName = 'funnel:common:optin:before-join-ref-subscribe-joi';


module.exports = {


  friendlyName: 'funnel:common:optin:before-join-ref-subscribe-joi',


  description: 'funnel:common:optin:before-join-ref-subscribe-joi',
