...
const moduleName = 'funnel:common:optin:callback-join-ref-start-joi';


module.exports = {


  friendlyName: 'funnel:common:optin:callback-join-ref-start-joi',


  description: 'funnel:common:optin:callback-join-ref-start-joi',
