...
const moduleName = 'funnel:common:optin:callback-make-payment-second-joi';


module.exports = {


  friendlyName: 'funnel:common:optin:callback-make-payment-second-joi',


  description: 'funnel:common:optin:callback-make-payment-second-joi',
