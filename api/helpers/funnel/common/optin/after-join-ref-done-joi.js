...
const moduleName = 'funnel:common:optin:after-join-ref-done-joi';


module.exports = {


  friendlyName: 'funnel:common:optin:after-join-ref-done-joi',


  description: 'funnel:common:optin:after-join-ref-done-joi',
