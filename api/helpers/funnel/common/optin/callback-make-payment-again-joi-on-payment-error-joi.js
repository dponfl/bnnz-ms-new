...
const moduleName = 'funnel:common:optin:callback-make-payment-again-on-payment-error-joi';


module.exports = {


  friendlyName: 'funnel:common:optin:callback-make-payment-again-on-payment-error-joi',


  description: 'funnel:common:optin:callback-make-payment-again-on-payment-error-joi',
