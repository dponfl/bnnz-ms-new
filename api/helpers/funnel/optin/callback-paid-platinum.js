module.exports = {
  ...
  friendlyName: 'optin::callbackPaidPlatinum',


  description: 'optin::callbackPaidPlatinum',
  ...
  fn: async function (inputs, exits) {
    ...
    try {
      ...
      sails.log.debug('/*************** optin::callbackPaidPlatinum ***************/');
      ...
      throw {err: {
          module: 'api/helpers/funnel/optin/callback-paid-platinum',
          message: 'api/helpers/funnel/optin/callback-paid-platinum error',
          payload: {
            params: inputs,
            error: {
