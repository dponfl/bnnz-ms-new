...
const moduleName = 'analytics:newAccountsActiveGoldPersonal';


module.exports = {


  friendlyName: 'analytics:newAccountsActiveGoldPersonal',

  description: 'Calculate data for new_accounts_active_gold_personal event',
