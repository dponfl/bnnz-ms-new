...
const moduleName = 'analytics:accountsBannedTestPersonalTotal';


module.exports = {


  friendlyName: 'analytics:accountsBannedTestPersonalTotal',

  description: 'Calculate data for accounts_banned_test_personal_total event',
