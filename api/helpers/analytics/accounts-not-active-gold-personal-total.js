...
const moduleName = 'analytics:accountsNotActiveGoldPersonalTotal';


module.exports = {


  friendlyName: 'analytics:accountsNotActiveGoldPersonalTotal',

  description: 'Calculate data for accounts_not_active_gold_personal_total event',
  ...
  fn: async function (inputs, exits) {
    ...
    let elapsedTime;
    let numAccounts;
    const serviceName = 'gold_personal';
