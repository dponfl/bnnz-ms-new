...
const moduleName = 'analytics:accountsDeletedBronzeCommercialTotal';


module.exports = {


  friendlyName: 'analytics:accountsDeletedBronzeCommercialTotal',

  description: 'Calculate data for accounts_deleted_bronze_commercial_total event',
