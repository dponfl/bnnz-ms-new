...
const moduleName = 'analytics:accountsActiveBronzePersonalTotal';


module.exports = {


  friendlyName: 'analytics:accountsActiveBronzePersonalTotal',

  description: 'Calculate data for accounts_active_bronze_personal_total event',
