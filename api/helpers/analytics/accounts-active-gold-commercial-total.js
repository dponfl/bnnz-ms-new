...
const moduleName = 'analytics:accountsActiveGoldCommercialTotal';


module.exports = {


  friendlyName: 'analytics:accountsActiveGoldCommercialTotal',

  description: 'Calculate data for accounts_active_gold_commercial_total event',
