...
const moduleName = 'analytics:accountsDeletedPlatinumPersonalTotal';


module.exports = {


  friendlyName: 'analytics:accountsDeletedPlatinumPersonalTotal',

  description: 'Calculate data for accounts_deleted_platinum_personal_total event',
  ...
  fn: async function (inputs, exits) {
    ...
    let elapsedTime;
    let numAccounts;
    const serviceName = 'platinum_personal';
