...
const moduleName = 'analytics:newAccountsActiveBronzePersonal';


module.exports = {


  friendlyName: 'analytics:newAccountsActiveBronzePersonal',

  description: 'Calculate data for new_accounts_active_bronze_personal event',
