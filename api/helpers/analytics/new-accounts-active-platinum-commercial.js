...
const moduleName = 'analytics:newAccountsActivePlatinumCommercial';


module.exports = {


  friendlyName: 'analytics:newAccountsActivePlatinumCommercial',

  description: 'Calculate data for new_accounts_active_platinum_commercial event',
