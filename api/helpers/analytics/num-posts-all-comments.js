...
const moduleName = 'analytics:numPostsAllComments';


module.exports = {


  friendlyName: 'analytics:numPostsAllComments',

  description: 'Calculate data for num_posts_all_comments event',
