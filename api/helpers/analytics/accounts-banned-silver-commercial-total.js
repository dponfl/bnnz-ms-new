...
const moduleName = 'analytics:accountsBannedSilverCommercialTotal';


module.exports = {


  friendlyName: 'analytics:accountsBannedSilverCommercialTotal',

  description: 'Calculate data for accounts_banned_silver_commercial_total event',
