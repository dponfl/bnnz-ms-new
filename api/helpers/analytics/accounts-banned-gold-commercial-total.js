...
const moduleName = 'analytics:accountsBannedGoldCommercialTotal';


module.exports = {


  friendlyName: 'analytics:accountsBannedGoldCommercialTotal',

  description: 'Calculate data for accounts_banned_gold_commercial_total event',
