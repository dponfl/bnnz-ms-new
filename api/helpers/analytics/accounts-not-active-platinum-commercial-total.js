...
const moduleName = 'analytics:accountsNotActivePlatinumCommercialTotal';


module.exports = {


  friendlyName: 'analytics:accountsNotActivePlatinumCommercialTotal',

  description: 'Calculate data for accounts_not_active_platinum_commercial_total event',
