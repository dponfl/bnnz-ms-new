...
const moduleName = 'analytics:accountsDeletedGoldPersonalTotal';


module.exports = {


  friendlyName: 'analytics:accountsDeletedGoldPersonalTotal',

  description: 'Calculate data for accounts_deleted_gold_personal_total event',
