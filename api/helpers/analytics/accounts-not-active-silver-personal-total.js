...
const moduleName = 'analytics:accountsNotActiveSilverPersonalTotal';


module.exports = {


  friendlyName: 'analytics:accountsNotActiveSilverPersonalTotal',

  description: 'Calculate data for accounts_not_active_silver_personal_total event',
