...
const moduleName = 'analytics:newAccountsActiveTestCommercial';


module.exports = {


  friendlyName: 'analytics:newAccountsActiveTestCommercial',

  description: 'Calculate data for new_accounts_active_test_commercial event',
