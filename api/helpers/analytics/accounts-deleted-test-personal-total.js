...
const moduleName = 'analytics:accountsDeletedTestPersonalTotal';


module.exports = {


  friendlyName: 'analytics:accountsDeletedTestPersonalTotal',

  description: 'Calculate data for accounts_deleted_test_personal_total event',
