...
const moduleName = 'analytics:accountsBannedSilverPersonalTotal';


module.exports = {


  friendlyName: 'analytics:accountsBannedSilverPersonalTotal',

  description: 'Calculate data for accounts_banned_silver_personal_total event',
