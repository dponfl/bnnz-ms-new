...
const moduleName = 'analytics:numPostsAccMax';


module.exports = {


  friendlyName: 'analytics:numPostsAccMax',

  description: 'Calculate data for num_posts_acc_max event',
...
`;
      ...
      if (rawResult.rows.length > 0) {
        ...
        numPostsMaxRec = _.maxBy(rawResult.rows, 'numRecords');
        numPostsMax = numPostsMaxRec.numRecords;

      }

      // sails.log.info('Min value: ', numPostsMax);
