...
const moduleName = 'analytics:newAccountsActivePlatinumPersonal';


module.exports = {


  friendlyName: 'analytics:newAccountsActivePlatinumPersonal',

  description: 'Calculate data for new_accounts_active_platinum_personal event',
