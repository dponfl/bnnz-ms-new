...
const moduleName = 'analytics:accountsDeletedTestCommercialTotal';


module.exports = {


  friendlyName: 'analytics:accountsDeletedTestCommercialTotal',

  description: 'Calculate data for accounts_deleted_test_commercial_total event',
