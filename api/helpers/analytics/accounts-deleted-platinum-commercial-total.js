...
const moduleName = 'analytics:accountsDeletedPlatinumCommercialTotal';


module.exports = {


  friendlyName: 'analytics:accountsDeletedPlatinumCommercialTotal',

  description: 'Calculate data for accounts_deleted_platinum_commercial_total event',
