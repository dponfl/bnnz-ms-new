...
const moduleName = 'analytics:newAccountsActiveSilverPersonal';


module.exports = {


  friendlyName: 'analytics:newAccountsActiveSilverPersonal',

  description: 'Calculate data for new_accounts_active_silver_personal event',
