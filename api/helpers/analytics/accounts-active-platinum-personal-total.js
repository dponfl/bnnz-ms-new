...
const moduleName = 'analytics:accountsActivePlatinumPersonalTotal';


module.exports = {


  friendlyName: 'analytics:accountsActivePlatinumPersonalTotal',

  description: 'Calculate data for accounts_active_platinum_personal_total event',
