...
const moduleName = 'analytics:newAccountsNotActiveGoldPersonal';


module.exports = {


  friendlyName: 'analytics:newAccountsNotActiveGoldPersonal',

  description: 'Calculate data for new_accounts_not_active_gold_personal event',
