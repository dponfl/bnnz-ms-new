...
const moduleName = 'analytics:newAccountsNotActiveBronzeCommercialTotal';


module.exports = {


  friendlyName: 'analytics:newAccountsNotActiveBronzeCommercialTotal',

  description: 'Calculate data for new_accounts_not_active_bronze_commercial event',
  ...
  fn: async function (inputs, exits) {
    ...
    let elapsedTime;
    let numAccounts;
    const serviceName = 'bronze_commercial';
