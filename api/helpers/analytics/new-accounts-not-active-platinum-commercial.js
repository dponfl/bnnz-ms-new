...
const moduleName = 'analytics:newAccountsNotActivePlatinumCommercial';


module.exports = {


  friendlyName: 'analytics:newAccountsNotActivePlatinumCommercial',

  description: 'Calculate data for new_accounts_not_active_platinum_commercial event',
