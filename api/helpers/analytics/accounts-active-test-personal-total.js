...
const moduleName = 'analytics:accountsActiveTestPersonalTotal';


module.exports = {


  friendlyName: 'analytics:accountsActiveTestPersonalTotal',

  description: 'Calculate data for accounts_active_test_personal_total event',
