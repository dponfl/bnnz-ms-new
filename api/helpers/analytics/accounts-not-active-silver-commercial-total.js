...
const moduleName = 'analytics:accountsNotActiveSilverCommercialTotal';


module.exports = {


  friendlyName: 'analytics:accountsNotActiveSilverCommercialTotal',

  description: 'Calculate data for accounts_not_active_silver_commercial_total event',
