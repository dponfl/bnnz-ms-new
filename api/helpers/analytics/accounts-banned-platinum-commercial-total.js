...
const moduleName = 'analytics:accountsBannedPlatinumCommercialTotal';


module.exports = {


  friendlyName: 'analytics:accountsBannedPlatinumCommercialTotal',

  description: 'Calculate data for accounts_banned_platinum_commercial_total event',
