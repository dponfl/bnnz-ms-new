...
const moduleName = 'analytics:accountsBannedBronzePersonalTotal';


module.exports = {


  friendlyName: 'analytics:accountsBannedBronzePersonalTotal',

  description: 'Calculate data for accounts_banned_bronze_personal_total event',
