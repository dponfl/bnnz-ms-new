...
const moduleName = 'analytics:accountsActiveSilverPersonalTotal';


module.exports = {


  friendlyName: 'analytics:accountsActiveSilverPersonalTotal',

  description: 'Calculate data for accounts_active_silver_personal_total event',
