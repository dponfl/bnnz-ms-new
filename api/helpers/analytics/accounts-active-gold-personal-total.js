...
const moduleName = 'analytics:accountsActiveGoldPersonalTotal';


module.exports = {


  friendlyName: 'analytics:accountsActiveGoldPersonalTotal',

  description: 'Calculate data for accounts_active_gold_personal_total event',
