...
const moduleName = 'analytics:accountsNotActiveBronzePersonalTotal';


module.exports = {


  friendlyName: 'analytics:accountsNotActiveBronzePersonalTotal',

  description: 'Calculate data for accounts_not_active_bronze_personal_total event',
  ...
  fn: async function (inputs, exits) {
    ...
    let elapsedTime;
    let numAccounts;
    const serviceName = 'bronze_personal';
