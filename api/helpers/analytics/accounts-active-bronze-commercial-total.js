...
const moduleName = 'analytics:accountsActiveBronzeCommercialTotal';


module.exports = {


  friendlyName: 'analytics:accountsActiveBronzeCommercialTotal',

  description: 'Calculate data for accounts_active_bronze_commercial_total event',
