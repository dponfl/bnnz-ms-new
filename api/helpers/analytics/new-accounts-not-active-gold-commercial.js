...
const moduleName = 'analytics:newAccountsNotActiveGoldCommercial';


module.exports = {


  friendlyName: 'analytics:newAccountsNotActiveGoldCommercial',

  description: 'Calculate data for new_accounts_not_active_gold_commercial event',
