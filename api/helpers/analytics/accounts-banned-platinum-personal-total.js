...
const moduleName = 'analytics:accountsBannedPlatinumPersonalTotal';


module.exports = {


  friendlyName: 'analytics:accountsBannedPlatinumPersonalTotal',

  description: 'Calculate data for accounts_banned_platinum_personal_total event',
