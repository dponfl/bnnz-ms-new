...
const moduleName = 'analytics:accountsDeletedGoldCommercialTotal';


module.exports = {


  friendlyName: 'analytics:accountsDeletedGoldCommercialTotal',

  description: 'Calculate data for accounts_deleted_gold_commercial_total event',
