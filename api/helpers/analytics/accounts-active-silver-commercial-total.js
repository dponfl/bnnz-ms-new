...
const moduleName = 'analytics:accountsActiveSilverCommercialTotal';


module.exports = {


  friendlyName: 'analytics:accountsActiveSilverCommercialTotal',

  description: 'Calculate data for accounts_active_silver_commercial_total event',
