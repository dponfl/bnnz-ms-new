...
const moduleName = 'analytics:newAccountsActiveGoldCommercial';


module.exports = {


  friendlyName: 'analytics:newAccountsActiveGoldCommercial',

  description: 'Calculate data for new_accounts_active_gold_commercial event',
