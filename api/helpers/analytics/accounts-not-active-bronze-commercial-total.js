...
const moduleName = 'analytics:accountsNotActiveBronzeCommercialTotal';


module.exports = {


  friendlyName: 'analytics:accountsNotActiveBronzeCommercialTotal',

  description: 'Calculate data for accounts_not_active_bronze_commercial_total event',
