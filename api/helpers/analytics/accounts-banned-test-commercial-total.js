...
const moduleName = 'analytics:accountsBannedTestCommercialTotal';


module.exports = {


  friendlyName: 'analytics:accountsBannedTestCommercialTotal',

  description: 'Calculate data for accounts_banned_test_commercial_total event',
