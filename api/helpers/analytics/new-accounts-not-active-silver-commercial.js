...
const moduleName = 'analytics:newAccountsNotActiveSilverCommercial';


module.exports = {


  friendlyName: 'analytics:newAccountsNotActiveSilverCommercial',

  description: 'Calculate data for new_accounts_not_active_silver_commercial event',
