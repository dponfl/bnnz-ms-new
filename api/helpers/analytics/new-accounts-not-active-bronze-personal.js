...
const moduleName = 'analytics:newAccountsNotActiveBronzePersonal';


module.exports = {


  friendlyName: 'analytics:newAccountsNotActiveBronzePersonal',

  description: 'Calculate data for new_accounts_not_active_bronze_personal event',
