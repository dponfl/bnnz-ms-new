...
const moduleName = 'analytics:accountsBannedBronzeCommercialTotal';


module.exports = {


  friendlyName: 'analytics:accountsBannedBronzeCommercialTotal',

  description: 'Calculate data for accounts_banned_bronze_commercial_total event',
