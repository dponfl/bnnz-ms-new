...
const moduleName = 'analytics:newAccountsActiveTestPersonalTotal';


module.exports = {


  friendlyName: 'analytics:newAccountsActiveTestPersonalTotal',

  description: 'Calculate data for new_accounts_active_test_personal event',
  ...
  fn: async function (inputs, exits) {
    ...
    let elapsedTime;
    let numAccounts;
    const serviceName = 'test_personal';
