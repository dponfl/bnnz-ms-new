...
const moduleName = 'analytics:accountsBannedGoldPersonalTotal';


module.exports = {


  friendlyName: 'analytics:accountsBannedGoldPersonalTotal',

  description: 'Calculate data for accounts_banned_gold_personal_total event',
