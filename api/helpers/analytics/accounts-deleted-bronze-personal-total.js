...
const moduleName = 'analytics:accountsDeletedBronzePersonalTotal';


module.exports = {


  friendlyName: 'analytics:accountsDeletedBronzePersonalTotal',

  description: 'Calculate data for accounts_deleted_bronze_personal_total event',
