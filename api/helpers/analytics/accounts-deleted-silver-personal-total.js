...
const moduleName = 'analytics:accountsDeletedSilverPersonalTotal';


module.exports = {


  friendlyName: 'analytics:accountsDeletedSilverPersonalTotal',

  description: 'Calculate data for accounts_deleted_silver_personal_total event',
