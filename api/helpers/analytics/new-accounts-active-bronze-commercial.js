...
const moduleName = 'analytics:newAccountsActiveBronzeCommercial';


module.exports = {


  friendlyName: 'analytics:newAccountsActiveBronzeCommercial',

  description: 'Calculate data for new_accounts_active_bronze_commercial event',
