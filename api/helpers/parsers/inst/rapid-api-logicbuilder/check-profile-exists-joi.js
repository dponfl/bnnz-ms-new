...
const moduleName = 'parsers:inst:rapid-api-logicbuilder:check-profile-exists-joi';


module.exports = {


  friendlyName: 'parsers:inst:rapid-api-logicbuilder:check-profile-exists-joi',
  ...
  fn: async function (inputs, exits) {
    ...
    try {
      ...
      const getUserMetadataJoiRes = await sails.helpers.parsers.inst.rapidApiLogicbuilder.getUserMetadataJoi(getUserMetadataParams);
