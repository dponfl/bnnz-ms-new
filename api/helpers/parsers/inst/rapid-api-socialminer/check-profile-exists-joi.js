...
const moduleName = 'parsers:inst:rapid-api-socialminer:check-profile-exists-joi';


module.exports = {


  friendlyName: 'parsers:inst:rapid-api-socialminer:check-profile-exists-joi',
  ...
  fn: async function (inputs, exits) {
    ...
    try {
      ...
      const getUserMetadataJoiRes = await sails.helpers.parsers.inst.rapidApiSocialminer.getUserMetadataJoi(getUserMetadataParams);
