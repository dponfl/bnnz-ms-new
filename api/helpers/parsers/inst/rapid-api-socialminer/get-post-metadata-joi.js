...
const moduleName = 'parsers:inst:rapid-api-socialminer:get-post-metadata-joi';


module.exports = {


  friendlyName: 'parsers:inst:rapid-api-socialminer:get-post-metadata-joi',


  description: 'parsers:inst:rapid-api-socialminer:get-post-metadata-joi',
  ...
  fn: async function (inputs, exits) {
    ...
    try {
      ...
      const parserAction = sails.config.custom.config.parsers.inst.rapidApiSocialminer.paths.getPostMetadata;
      ...
      if (_.isNil(requestRes.success)) {
        ...
        await LogProcessor.error({
          message: sails.config.custom.INST_PARSER_WRONG_RESPONSE_STATUS.message + ': No "success" key',
          clientGuid,
          accountGuid,
          // requestId: null,
          // childRequestId: null,
      ...
      const mediaId = _.get(requestRes, 'data.id', null);
