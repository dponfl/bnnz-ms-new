...
const moduleName = 'parsers:inst:rapid-api-socialminer:get-comments-joi';


module.exports = {


  friendlyName: 'parsers:inst:rapid-api-socialminer:get-comments-joi',
  ...
  fn: async function (inputs, exits) {
    ...
    try {
      ...
      const parserAction = sails.config.custom.config.parsers.inst.rapidApiSocialminer.paths.getComments;
