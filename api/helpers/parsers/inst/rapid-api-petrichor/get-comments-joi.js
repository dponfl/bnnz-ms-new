...
const moduleName = 'parsers:inst:rapid-api-petrichor:get-comments-joi';


module.exports = {


  friendlyName: 'parsers:inst:rapid-api-petrichor:get-comments-joi',
  ...
  fn: async function (inputs, exits) {
    ...
    try {
      ...
      const parserAction = sails.config.custom.config.parsers.inst.rapidApiPetrichor.paths.getComments;
