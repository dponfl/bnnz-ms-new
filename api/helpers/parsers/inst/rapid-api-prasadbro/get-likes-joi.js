...
const moduleName = 'parsers:inst:rapid-api-prasadbro:get-likes-joi';


module.exports = {


  friendlyName: 'parsers:inst:rapid-api-prasadbro:get-likes-joi',
  ...
  fn: async function (inputs, exits) {
    ...
    try {
      ...
      const parserAction = sails.config.custom.config.parsers.inst.rapidApiPrasadbro.paths.getLikes;
      ...
      if (
        _.isNil(requestRes.body.shortcode)
        || requestRes.body.shortcode !== input.shortCode
      ) {
