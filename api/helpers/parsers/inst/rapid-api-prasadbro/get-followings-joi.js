...
const moduleName = 'parsers:inst:rapid-api-prasadbro:get-followings-joi';


module.exports = {


  friendlyName: 'parsers:inst:rapid-api-prasadbro:get-followings-joi',


  description: 'parsers:inst:rapid-api-prasadbro:get-followings-joi',
  ...
  fn: async function (inputs, exits) {
    ...
    try {
      ...
      const parserAction = sails.config.custom.config.parsers.inst.rapidApiPrasadbro.paths.getFollowing;
      ...
      if (input.nextMaxId != null) {
        options.qs.next_max_id = _.trim(input.nextMaxId);
      }
      ...
      const users = _.get(requestRes, 'body.users', []);
      const bigList = _.get(requestRes, 'body.big_list', null);
      const nextMaxId = _.get(requestRes, 'body.next_max_id', null);
