...
const moduleName = 'keyboards:silver-personal:account:home-menu-joi';


module.exports = {


  friendlyName: 'keyboards:silver-personal:account:home-menu-joi',


  description: 'keyboards:silver-personal:account:home-menu-joi',
