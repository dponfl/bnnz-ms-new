...
const moduleName = 'keyboards:silver-personal:home:account-joi';


module.exports = {


  friendlyName: 'keyboards:silver-personal:home:account-joi',


  description: 'keyboards:silver-personal:home:account-joi',
