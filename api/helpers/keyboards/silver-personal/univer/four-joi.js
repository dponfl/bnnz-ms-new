...
const moduleName = 'keyboards:silver-personal:univer:four-joi';


module.exports = {


  friendlyName: 'keyboards:silver-personal:univer:four-joi',


  description: 'keyboards:silver-personal:univer:four-joi',
