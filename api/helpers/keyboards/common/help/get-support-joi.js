...
const moduleName = 'keyboards:common:help:get-support-joi';


module.exports = {


  friendlyName: 'keyboards:common:help:get-support-joi',


  description: 'keyboards:common:help:get-support-joi',
  ...
  fn: async function (inputs, exits) {
    ...
    try {
      ...
      const messageDataPath = 'keyboards.help.getSupport';
