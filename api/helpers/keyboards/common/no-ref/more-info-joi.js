...
const moduleName = 'keyboards:silver-personal:no-ref:more-info-joi';


module.exports = {


  friendlyName: 'keyboards:silver-personal:no-ref:more-info-joi',


  description: 'keyboards:silver-personal:no-ref:more-info-joi',
  ...
  fn: async function (inputs, exits) {
    ...
    try {
      ...
      /**
       * Установить в client, что выполняется воронка "noRefInfo"
       */

      input.client.current_funnel = 'noRefInfo';
