...
const moduleName = 'keyboards:common:ref:get-ref-payout-joi';


module.exports = {


  friendlyName: 'keyboards:common:ref:get-ref-payout-joi',


  description: 'keyboards:common:ref:get-ref-payout-joi',
  ...
  fn: async function (inputs, exits) {
    ...
    try {
      ...
      const messageDataPath = 'keyboards.ref.refPayout';
