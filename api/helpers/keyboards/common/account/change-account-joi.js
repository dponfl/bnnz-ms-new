...
const moduleName = 'keyboards:common:account:change-account-joi';


module.exports = {


  friendlyName: 'keyboards:common:account:change-account-joi',


  description: 'keyboards:common:account:change-account-joi',
  ...
  fn: async function (inputs, exits) {
    ...
    try {
      ...
      /**
       * Отправляем сообщение, что данная функциональность
       * будет реализована в последующих релизах
       */


      const messageDataPath = 'keyboards.account.changeAccount';
