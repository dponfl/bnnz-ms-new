...
const moduleName = 'keyboards:common:account:add-account-joi';


module.exports = {


  friendlyName: 'keyboards:common:account:add-account-joi',


  description: 'keyboards:common:account:add-account-joi',
  ...
  fn: async function (inputs, exits) {
    ...
    try {
      ...
      const messageDataPath = 'keyboards.account.addAccount';
