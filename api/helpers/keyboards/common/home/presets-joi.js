...
const moduleName = 'keyboards:common:home:presets-joi';


module.exports = {


  friendlyName: 'keyboards:common:home:presets-joi',


  description: 'keyboards:common:home:presets-joi',
  ...
  fn: async function (inputs, exits) {
    ...
    try {
      ...
      const messageDataPath = 'keyboards.presets.presets';
