...
const moduleName = 'push-messages:push-to-paid:personal:callback-call-to-action-four';


module.exports = {


  friendlyName: 'push-messages:push-to-paid:personal:callback-call-to-action-four',


  description: 'push-messages:push-to-paid:personal:callback-call-to-action-four',
