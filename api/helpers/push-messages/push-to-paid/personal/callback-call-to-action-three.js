...
const moduleName = 'push-messages:push-to-paid:personal:callback-call-to-action-three';


module.exports = {


  friendlyName: 'push-messages:push-to-paid:personal:callback-call-to-action-three',


  description: 'push-messages:push-to-paid:personal:callback-call-to-action-three',
