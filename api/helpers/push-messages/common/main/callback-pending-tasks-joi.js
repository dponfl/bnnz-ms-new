...
const moduleName = 'push-messages:common:main:callback-pending-tasks-joi';


module.exports = {


  friendlyName: 'push-messages:common:main:callback-pending-tasks-joi',


  description: 'Обработка callback сообщения, полученного при нажатии кнопки проверить невыполненные задания',
